  ...
  return (
    <ComposerPrimitive.AddAttachment asChild>
      <TooltipIconButton
        ...
        variant="ghost"
        size="icon"
  className="aui-composer-add-attachment size-[34px] rounded-md p-1 text-xs font-semibold hover:bg-muted-foreground/15 dark:border-muted-foreground/15 dark:hover:bg-muted-foreground/30"
        aria-label="Add Attachment"
      >
        {/* Add PlusIcon for visual clarity */}
